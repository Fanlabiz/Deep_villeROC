...
def build_excel(df, ville):
    ...
    if rows_df.empty:
        return None
    # Sépare les vrais bâtiments des blocs locked
    locked_df = rows_df[rows_df['Nom_complet'] == 'LOCKED_BLOCK'].copy()
    rows_df   = rows_df[rows_df['Nom_complet'] != 'LOCKED_BLOCK'].copy()
